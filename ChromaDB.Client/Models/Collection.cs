...
[ChromaPostRoute(Endpoint = "collections/{collection_id}/delete", Source = typeof(Collection), RequestType = typeof(CollectionDeleteRequest), ResponseType = typeof(List<string>))]
